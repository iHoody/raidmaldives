    ...
    <div class="booking-modal__container">
        ...
        <div class="booking-modal__content">
            <div class="booking-modal__header">
                <h2 class="booking-modal__title"><?php esc_html_e('Book Your Dive Experience', 'dive-raid'); ?></h2>
            ...
            <div class="booking-modal__body">
                ...
                <div class="booking-modal__form" style="display: none;">
                    <div class="booking-form__field">
                        <label for="event-type-select"><?php esc_html_e('Select Dive Package', 'dive-raid'); ?></label>
